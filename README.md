...
| 학력 및 교육 수료           |기간       |
| ------------------- | ----------- | 
| **AI SW 마에스트로 17기** |  **2026.05 ~ 2026.12** |
...
|AI/ML Frameworks| ![Spring AI](https://img.shields.io/badge/Spring%20AI-6DB33F?style=for-the-badge&logo=spring&logoColor=white) ![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=for-the-badge&logo=chainlink&logoColor=white)|
...
🥈 **2025 한국지능정보사회진흥원 AI 챌린지 시즌2 최우수상**
 -  KTAS 코드 기반 응급실 병상 매칭 및 의료 문서 RAG 검색 시스템 구현

🏅 **2025 호남 IS 코딩챌린지 장려상**
- 전주시 가맹점 검색을 위한 공공데이터 기반 AI 챗봇

🥇 **2024 전북특별자치도 공공데이터 활용 창업경진대회 대상**
- 공공데이터 기반 동물 의약/식품 상세 검색 개발

### 교내 수상
🥈 **2025 전북대학교 컴퓨터인공지능학부 경진대회 은상**
- 내부 문서 검색을 위한 RAG 기반 MCP 서비스 구축

🥉 **2025 전북대학교 SW중심사업단 캡스톤디자인 우수상**
- 건설·행정 법률 문서 기반 RAG 질의응답 시스템 개발
